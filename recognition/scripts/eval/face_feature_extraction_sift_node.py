...
class FaceFeatureExtractionNode:
	def __init__(self, sensor_name):
		...
		self.calc_image_features_srv = rospy.ServiceProxy('calc_image_features', CalcImageFeatures)
	...
	def extract_features(self, rgb_image, box_2d):
		...
		msg = self.cv_bridge.cv2_to_imgmsg(face_roi, 'bgr8')
		res = self.calc_image_features_srv(msg)
		if len(res.features.data) < 5:
			return None, None
		return rgb_image[top:bottom, left:right], res.features.data
